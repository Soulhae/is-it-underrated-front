        ...
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 p-6">
                ...
                {steam_games?.map((game) => (
                    <Link key={game.app_id} href={`/game/${game.app_id}?from=${currentPage}`} className="flex flex-col bg-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
